...
import { localizedSeoAlgorithm, pageSeo, seoUrl } from '../src/seo.js';
...
console.log(`SEO OK: ${expectedUrls} URLs bilingües, canonicals, hreflang, JSON-LD, sitemap y robots verificados.`);
