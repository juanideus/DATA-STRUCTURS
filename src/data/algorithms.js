...
export const algorithms = [
  ...
  item('arbol-general','Árbol general','Árboles','tree','Recorridos O(n)','Jerarquía sin límite fijo de hijos por nodo.',`DFS(nodo):\n  visitar(nodo)\n  para cada hijo de nodo\n    DFS(hijo)`,[8,3,12,1,5,10,15]),
  ...
  item('trie','Trie','Árboles','trie','Operaciones O(L)','Árbol de prefijos: cada ruta representa una palabra.',`buscar(palabra):\n  nodo ← raíz\n  para cada carácter c\n    si no existe hijo[c]: falso\n    nodo ← hijo[c]\n  retornar nodo.esFinal`,['C','A','S','A','R','O','L']),
  ...
  item('dijkstra','Dijkstra','Grafos','weighted','O((V + E) log V)','Encuentra caminos mínimos desde un origen con pesos no negativos.',`dist[origen] ← 0\nmientras queden vértices\n  u ← extraerMin()\n  para cada (u,v,peso)\n    relajar(u,v,peso)`,['A','B','C','D','E','F']),
